...
const (
	...
	flareServerPackage   = protogen.GoImportPath("github.com/flare-rpc/flarego/server")
	flareClientPackage   = protogen.GoImportPath("github.com/flare-rpc/flarego/client")
	flareProtocolPackage = protogen.GoImportPath("github.com/flare-rpc/flarego/protocol")
)
...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + ".flare.pb.go"
...
func generateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("var _ = ", flareServerPackage.Ident("NewServer"))
	g.P("var _ = ", flareClientPackage.Ident("NewClient"))
	g.P("var _ = ", flareProtocolPackage.Ident("NewMessage"))
	g.P()
